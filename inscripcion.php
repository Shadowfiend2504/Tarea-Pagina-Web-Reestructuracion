        ...
        <div id="main">
            <section class="main">
                ...
                <form enctype="multipart/form-data" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                    <?php 
                        include 'Inscripcion/formulario_inscripcion.php'; 
                        include 'Inscripcion/campos_principales.php'; 
                        include 'Inscripcion/disponibilidad_actividad.php'; 
                        include 'Inscripcion/duracion_detalles.php'; 
                        include 'Inscripcion/publico_objetivo.php'; 
                        include 'Inscripcion/imagen_promocional.php'; 
                        include 'Inscripcion/datos_registrante.php'; 
                        include 'Inscripcion/opciones_publicacion.php'; 
                        include 'Inscripcion/boton_envio.php'; 
                        include 'Inscripcion/redes_sociales.php'; 
                        include 'Inscripcion/footer.php'; 
                    ?>
                </form>
            </section>
        </div>
